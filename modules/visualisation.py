...
import json
import os
from modules.config import START_MONTH, START_YEAR, END_MONTH, END_YEAR, HIGH_MAG_THRESHOLD, MAP_MODE, OUTPUT_DIR, OUTPUT_EQ_MAPS_DIR
...
def map_maker_general (data, filtered_features, gj, HIGH_MAG_THRESHOLD, MAP_MODE=MAP_MODE):
    ...
    output_path = f'{OUTPUT_DIR}/{OUTPUT_EQ_MAPS_DIR}/{MAP_MODE}_Map_{START_MONTH}.{START_YEAR}_{END_MONTH}.{END_YEAR}_{ct}.html' 
